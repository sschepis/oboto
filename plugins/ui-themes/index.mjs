...
const THEME_PRESETS = {
    ...
    solarized: {
        ...
        'color-surface-overlay': '#eee8d5',
        'color-border': 'rgba(101,123,131,0.2)', 'color-border-rgb': '101,123,131',
        'color-text': '#657b83', 'color-text-muted': '#586e75',
    ...
    mermaid: {
        ...
        'color-accent': '#d81b60', 'color-accent-rgb': '255,159,243',
        'color-success': '#2ecc71', 'color-warning': '#e65100',
    ...
    quiet: {
        ...
        'color-success': '#2e7d32', 'color-warning': '#f9a825',
