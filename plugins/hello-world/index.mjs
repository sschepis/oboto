/**
 * Hello World Plugin — demonstrates all major plugin API capabilities.
 *
...
const SETTINGS_SCHEMA = [
  ...
  { key: 'greetingEmoji', label: 'Greeting Emoji', type: 'text', description: 'Emoji appended to greetings', default: '👋' },
...
export async function activate(api) {
    ...
    api.tools.register({
        ...
        handler: async (args) => {
            const emoji = pluginSettings.greetingEmoji || '👋';
