/**
 * Preferences manager for RoboDev tray app.
 *
 * Persists configuration to ~/.robodev-service/preferences.json
...
const PREFS_DIR = path.join(os.homedir(), '.robodev-service');
